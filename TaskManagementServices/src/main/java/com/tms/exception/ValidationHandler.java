...
public class ValidationHandler {
	...
	public ResponseEntity<ExceptionEntity> checkMethodNotFound(BadRequest exception) {
		ExceptionEntity exception1 = new ExceptionEntity();
		...
		return new ResponseEntity<ExceptionEntity>(exception1, HttpStatus.BAD_REQUEST);
